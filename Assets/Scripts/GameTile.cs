...
public class GameTile : MonoBehaviour
{
    ...
    public GameTile GrowPassNorth() => GrowPathTo(_north);
    public GameTile GrowPassSouth() => GrowPathTo(_south);
    public GameTile GrowPassEast() => GrowPathTo(_east);
    public GameTile GrowPassWest() => GrowPathTo(_west);
